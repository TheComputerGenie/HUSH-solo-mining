...
var BlockTemplate = module.exports = function BlockTemplate(jobId, rpcData, poolAddress, poolPubkey) {
    var submits = [];
    ...
    var foundersFee = (this.rpcData.founder);
    var fees = [];
    ...
    this.generationTransaction = transactions.createGeneration(rpcData.height, blockReward, foundersFee, this.rewardFees, poolAddress, poolPubkey).toString('hex');
