...
```javascript
{
    "coin": "HUSH3.json",                              // the file in 'coins' folder that defines current used coin
    "address": "RCAoBKuWio6cTCiTnRDWZzMc3Wi4Cawrq6",    // the transparent address you want reward to go to
    "pubkey": "02cc36ade8ecdb0611511ff834a2623f5e626efb87d7fc421c6832545cfdb9e128", // the pbkey of your transparent address above
...
```javascript
{
    "name": "Hush v3",           // The name of the coin
    "symbol": "HUSH",            // The coin's ticker symbol
    "peerMagic": "f9eee48d",    // easiest way to find this is run daemon -- magic.17b6e058 becomes 58e0b617
    "foundersAddy": "RHushEyeDm7XwtaTWtyCbjGQumYyV8vMjn", // the address founders' rewad goes to; this will not change
